...
class DetailUlanganController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('guru.detail_ulangan.kelas', compact('kelas', 'guru'));
    }
    ...
    public function show($id)
    {
        ...
        return view('guru.detail_ulangan.nilai', compact('guru', 'kelas', 'siswa'));
    }
